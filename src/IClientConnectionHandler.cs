...
public interface IClientConnectionHandler
{
    ...
    /// </summary>
    /// <remarks>
    /// If the connection is not closed when this method returns (<see cref="IClientConnection.Exit(int)"/>), it is automatically closed with exit code 0.
