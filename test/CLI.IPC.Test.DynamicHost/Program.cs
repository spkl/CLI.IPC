...
namespace spkl.CLI.IPC.Test.DynamicHost;
...
internal class Program
{
    static void Main(string[] args)
    {
        ...
        Type clientConnectionHandlerType = Type.GetType(typeName + ", spkl.CLI.IPC, Version=2.0.0.0, Culture=neutral, PublicKeyToken=e5ae298f5c89d3e9")
